...
function AddCharges() {
    ...
    function submitHandler(event){
        ...
        axios
          .post("  http://localhost:8080/CustomizePlan/charges", json, config)
          .then((response) => {
  ...
  return (
    <div className="col-md-6 offset-md-3 card card-body mt-5 coform mb-5" id="co">
      <form name="myForm" onSubmit={submitHandler}>
        <h3 className="mb-5 text-muted text-center mt-5">Add charge</h3>
        ...
        <div className="form-group">
          ...
          <input
            ...
            name="strategyCost"
            placeholder="Enter strategyCost"
          />
        </div>
        ...
        <div className="form-group">
          <label>validityInDays Id</label>
          <input
            type="number"
            id="vdays"
            name="validityInDays"
            className="form-control"
            placeholder="Enter validityInDays "
          />
        </div>

      
        <div>
          <button className="btn btn-primary mt-4 subtn" type="submit">Add charge</button>
        </div>
      </form>
    </div>
  );
